    ...
    try {
        ...
        const emailHtml = `
            <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #1a1a1a;">
                <h2>Your Vanguard Application is Approved</h2>
                <p>Congratulations!</p>
                <p>The Industrialise Africa team has reviewed your application and we are thrilled to invite you to join the Vanguard tier.</p>
                ...
                <a href="https://industrialiseafrica.com/login" style="display: inline-block; padding: 12px 24px; background: #c61c28; color: white; text-decoration: none; font-weight: bold; margin-top: 16px;">Complete Payment</a>
            </div>
        `;
        
        await sendEmail(email, "Your Vanguard Application is Approved!", emailHtml, "approval");
