        ...
        <div onClick={e => { if (e.target === e.currentTarget) onClose() }} style={{ position: "fixed", inset: 0, zIndex: 500, background: "rgba(0,0,0,0.88)", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
            <div style={{ background: T.white, maxWidth: 500, width: "100%", maxHeight: "92vh", overflowY: "auto", animation: "modalIn 0.2s ease", borderTop: `3px solid ${T.gold}` }}>
                ...
                <div style={{ padding: "24px 26px" }}>
                    ...
                    {step === 4 && <>
                        <FG><L t="Company staff size" /><select value={f.network} onChange={e => set("network", e.target.value)} style={ss}><option value="">Select...</option>{["0 - 5", "5 - 20", "20 - 50", "50 - 100", "100 and above"].map(n => <option key={n}>{n}</option>)}</select></FG>
                        ...
                        <FG><L t="Membership tier interest" /><select value={f.tier} onChange={e => set("tier", e.target.value)} style={ss}><option value="Builder">Builder — $15/mo (₦21,000)</option><option value="Catalyst">Catalyst — $75/mo (₦105,000)</option><option value="Vanguard">Vanguard — $500/mo (₦700,000)</option></select></FG>
