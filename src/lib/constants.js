export const T = {
  black: "#000000", dark: "#0f172a", dark2: "#1e293b", dark3: "#334155",
  mid: "#475569", grey: "#64748b", greyLt: "#94a3b8",
  rule: "#e2e8f0", ruleLt: "#f1f5f9",
  ivory: "#f8fafc", ivory2: "#f1f5f9",
  white: "#ffffff",
  gold: "#dc2626", gold2: "#b91c1c", goldLt: "#fef2f2",
  red: "#0f172a", red2: "#1e293b", redLt: "#f1f5f9",
  primary: "#dc2626", primaryHover: "#b91c1c", primaryLight: "#fef2f2"
};

export const F = { display: "'Inter', sans-serif", body: "'Inter', sans-serif", mono: "'Inter', sans-serif" };
...
export const TIERS = [
  ...
  {
      id: "catalyst", name: "Catalyst", tagline: "Accelerate your impact. Access real opportunity.", price: "$75", sub: "per month · ₦105,000", annual: "$750 / ₦1,050,000 per year (save 2 months)", color: T.primary, badge: "Most Popular", cta: "Join as Catalyst",
  ...
  {
      id: "vanguard", name: "Vanguard", tagline: "Lead the movement. Shape the agenda.", price: "$500", sub: "per month · ₦700,000", annual: "$5,000 / ₦7,000,000 upfront (save 2 months)", color: T.dark, badge: "Limited", cta: "Apply for Vanguard",
